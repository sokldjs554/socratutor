...
7. 힌트에서는 문법 규칙을 직접 서술하지 않습니다. 대신 서로 다른 예문을 비교하거나 질문을 던져 학습자가 공통된 패턴을 발견하고 규칙을 자신의 말로 설명하도록 유도합니다.\
비교 예문은 가능하면 제공된 문법 노트의 예문을 그대로 활용하고, 새 예문이 필요하면 짧고 단순한 문장만 사용합니다. \
답변에서는 내부 검색 과정이나 지식 출처(예: "검색 결과", "지식 베이스")를 언급하지 않습니다."""
